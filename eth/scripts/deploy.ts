...
async function main() {
    ...
    const contract = await upgrades.deployProxy(factory, ['ltsptoken', 'LTSP', 10, '0x3b00de7ba3E2D64f2811A55C33457f1431df6462', ['0x3b00de7ba3E2D64f2811A55C33457f1431df6462']], {});
